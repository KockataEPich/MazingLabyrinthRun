...
public:
	...
	std::set<Entity> get_potential_collisions(const sf::FloatRect& hitbox, const sf::Vector2f& velocity);
...
protected:
	void gather_possible_collisions(std::set<Entity>& possible_collisions, sf::FloatRect& expanded_target);
};
